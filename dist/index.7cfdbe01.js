...
*/ (function(global, factory) {
    ...
    var scrollOverflowHandler = {
        ...
        makeScrollable: function makeScrollable() {
            ...
            getState().panels.forEach(function(el) {
                if (hasClass(el.item, "fp-noscroll") || hasClass(el.item, AUTO_HEIGHT_RESPONSIVE) && isResponsiveMode()) return;
                else {
        ...
        isScrolled: function isScrolled(direction, el) {
            ...
            if (!getOptions().scrollOverflow || !hasClass(scrollableItem, OVERFLOW)) return true;
    ...
    */ function afterSectionLoads(v) {
        if (getOptions().fitToSection) // Removing CSS snaps for auto-scrolling sections
        {
            if (hasClass($(SECTION_ACTIVE_SEL)[0], AUTO_HEIGHT)) css(doc.body, {
                "scroll-snap-type": "none"
            });
        }
        setState({
    ...
    */ function getActiveSlide() {
    ...
    !function() {
        ...
        var n = "2022-7-7".split("-"), e = new Date(n[0], n[1], n[2]), i = [
            "se",
            "licen",
            "-",
            "v3",
...
//# sourceMappingURL=index.7cfdbe01.js.map
